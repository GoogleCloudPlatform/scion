...
EXPECTED_SCRIPTS=5
EXPECTED_ASSERTIONS=240   # 49 chart-integrity + 110 render-guards + 31 reserved-flags + 4 update-strategy + 46 rbac-collision. render-guards includes +33 from F2 name-axis separators, multi-line-leaf rows, and anchor-class rows.
...
SCRIPTS=(
  ...
  render-guards.sh      # 110 - every other render-time refusal, incl. the HA-unlanded gate
