...
/**
 * Admin Access Boundary detail page component (stub).
 *
 * Placeholder that will be fleshed out in F3. Extracts the boundary ID
 * from the URL so the routing shell is complete.
 */
  ...
  override render() {
    return html`
      <div class="placeholder">
        <h1>Access Boundary: ${this.boundaryId}</h1>
        <p>Coming soon</p>
      </div>
    `;
  }
