...
| **N1** (Nit) Test comments cited design row labels (`F4-1`…`F4-6`) | **Partially fixed at the time** (corrected in fix round 2, see below): reworded most such comments, but missed one at `adminoverlay_test.go:1146` ("… and F4-*"). | — |
