...
description: Daily release notes from the early development period (Feb–Jul 2026).
---

This archive contains the daily release notes from the early development period of Scion, covering February 19 through July 29, 2026. Current release notes use a weekly summary format on the main [Release Notes](/scion/release-notes/) page.
