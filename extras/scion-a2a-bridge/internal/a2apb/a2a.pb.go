...
const file_a2a_proto_rawDesc = "" +
	...
	"\bmetadata\x18\x06 \x01(\v2\x17.google.protobuf.StructR\bmetadata\"S\n" +
	...
	"\x06header\x18\x03 \x01(\v2\x17.google.protobuf.StructR\x06header\"\xd1\x01\n" +
	...
	"\x03url\x18\x04 \x01(\tB\x03\xe0A\x02R\x03url\x12\x14\n" +
	...
	"\x06tenant\x18\x01 \x01(\tR\x06tenant\x12\x1c\n" +
	"\atask_id\x18\x02 \x01(\tB\x03\xe0A\x02R\x06taskId\x12\x13\n" +
	"\x02id\x18\x03 \x01(\tB\x03\xe0A\x02R\x02id\"E\n" +
	...
	"\x0fSubscribeToTask\x12!.lf.a2a.v1.SubscribeToTaskRequest\x1a\x19.lf.a2a.v1.StreamResponse\"C\x82\xd3\xe4\x93\x02=Z\"\x12 /{tenant}/tasks/{id=*}:subscribe\x12\x17/tasks/{id=*}:subscribe0\x01\x12\xf3\x01\n" +
	" CreateTaskPushNotificationConfig\x12%.lf.a2a.v1.TaskPushNotificationConfig\x1a%.lf.a2a.v1.TaskPushNotificationConfig\"\x80\x01\xdaA\x0etask_id,config\x82\xd3\xe4\x93\x02i:\x01*Z8:\x01*\"3/{tenant}/tasks/{task_id=*}/pushNotificationConfigs\"*/tasks/{task_id=*}/pushNotificationConfigs\x12\xfe\x01\n" +
	...
	"task_id,id\x82\xd3\xe4\x93\x02qZ<*:/{tenant}/tasks/{task_id=*}/pushNotificationConfigs/{id=*}*1/tasks/{task_id=*}/pushNotificationConfigs/{id=*}Bv\n" +
	"\x14com.google.lf.a2a.v1B\x03A2AP\x01ZKgithub.com/GoogleCloudPlatform/scion/extras/scion-a2a-bridge/internal/a2apb\xaa\x02\tLf.A2a.V1b\x06proto3"
