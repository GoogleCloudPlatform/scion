...
func (*Schedule) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case schedule.FieldID, schedule.FieldGroveID, schedule.FieldName, schedule.FieldCronExpr, schedule.FieldEventType, schedule.FieldPayload, schedule.FieldStatus, schedule.FieldLastRunStatus, schedule.FieldLastRunError, schedule.FieldCreatedBy:
			values[i] = new(sql.NullString)
		case schedule.FieldNextRunAt, schedule.FieldLastRunAt, schedule.FieldCreatedAt, schedule.FieldUpdatedAt:
