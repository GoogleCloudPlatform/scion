...
const (
	// Label holds the string label denoting the harnessconfig type in the database.
	Label = "harness_config"
	...
	// Table holds the table name of the harnessconfig in the database.
	Table = "harness_configs"
)

// Columns holds all SQL columns for harnessconfig fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldSlug,
...
// OrderOption defines the ordering options for the HarnessConfig queries.
