...
func (_u *TemplateUpdate) SetGroveID(v string) *TemplateUpdate {
	_u.mutation.SetGroveID(v)
	return _u
}

// SetNillableGroveID sets the "grove_id" field if the given value is not nil.
func (_u *TemplateUpdate) SetNillableGroveID(v *string) *TemplateUpdate {
	if v != nil {
		_u.SetGroveID(*v)
	}
	return _u
...
func (_u *TemplateUpdate) ClearGroveID() *TemplateUpdate {
...
func (_u *TemplateUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.GroveID(); ok {
		_spec.SetField(template.FieldGroveID, field.TypeString, value)
	}
	if _u.mutation.GroveIDCleared() {
		_spec.ClearField(template.FieldGroveID, field.TypeString)
	}
...
// SetGroveID sets the "grove_id" field.
func (_u *TemplateUpdateOne) SetGroveID(v string) *TemplateUpdateOne {
	_u.mutation.SetGroveID(v)
	return _u
}

// SetNillableGroveID sets the "grove_id" field if the given value is not nil.
func (_u *TemplateUpdateOne) SetNillableGroveID(v *string) *TemplateUpdateOne {
	if v != nil {
		_u.SetGroveID(*v)
	}
	return _u
...
// ClearGroveID clears the value of the "grove_id" field.
func (_u *TemplateUpdateOne) ClearGroveID() *TemplateUpdateOne {
	_u.mutation.ClearGroveID()
	return _u
}
