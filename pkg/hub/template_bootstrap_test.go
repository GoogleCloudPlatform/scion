...
// setupWorkspaceProject creates a server, store, grove, and workspace temp dir
...
func TestImportTemplatesFromWorkspace_ImportsTemplates(t *testing.T) {
	srv, s, grove, wsRoot := setupWorkspaceProject(t, "ws-import")
	ctx := context.Background()
...
func TestImportTemplatesFromWorkspace_DefaultPath(t *testing.T) {
	srv, s, grove, wsRoot := setupWorkspaceProject(t, "ws-default")
	ctx := context.Background()
	...
	result, err := s.ListTemplates(ctx, store.TemplateFilter{ProjectID: grove.ID}, store.ListOptions{Limit: 10})
	if err != nil {
		t.Fatal(err)
	}
	if result.TotalCount != 1 {
...
func TestImportTemplatesFromWorkspace_NonexistentPath(t *testing.T) {
	srv, _, grove, _ := setupWorkspaceProject(t, "ws-nopath")
	ctx := context.Background()
...
func TestImportTemplatesFromWorkspace_NoTemplatesFound(t *testing.T) {
	srv, _, grove, wsRoot := setupWorkspaceProject(t, "ws-empty")
	ctx := context.Background()
...
func TestImportTemplatesFromWorkspace_PathTraversal(t *testing.T) {
	srv, _, grove, _ := setupWorkspaceProject(t, "ws-traversal")
	ctx := context.Background()
...
func TestImportTemplatesFromWorkspace_MultipleTemplates(t *testing.T) {
	srv, s, grove, wsRoot := setupWorkspaceProject(t, "ws-multi")
	ctx := context.Background()
